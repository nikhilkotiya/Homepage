        ...
        <div>
            ...
            <div className="container2">
                <div className="trustedby">
                    <span >
                        Trusted by <span className='style-trustedby'>100+ Local Brands<div className='headingicon2'><img src={photo27} alt="" /></div></span>
                    </span>
                </div>
                <div className="img2">
    ...
    <div className ="allcompanyicons">
        ...
        <div className = "companyicon ramenicon">    <img  src="./RC website Mobile (2)/Vector Smart Object-1 2.svg" alt=""/>
            ...
            <div className="container3">
                <div className="text1">
                    Right Choice <span class="style">is made for <div className='headingicon3'><img src={photo28}alt="" /></div>
                    </span>
                </div>
                <div className="icons">
...
<div className="container5">
    ...
    <div className="text1">
        <div>
            ...
            <div className='headingicon5'><img  src={photo31}alt="" /></div></span>
